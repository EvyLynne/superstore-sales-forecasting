...
Forecasting project end to end: the numbered document set (01, 08, 12, 13, 15, 18, 20, 21, 22, 24, 30), the Power BI report (binary and
...
| Folder | Contents |
|---|---|
| `docs/` | Numbered document set (01, 08, 12, 13, 15, 18, 20, 21, 22, 24, 30) |
...
| `evaluation/` | Evaluation notebook and supporting tables (document 22) |
